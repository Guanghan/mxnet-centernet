...
'''
location: the center (x,y,z) of the 3d object in camera coordinate system / world coordinate system?
'''

# based on the car center location and car size, find the corners (3d bbox)
...
# car corners (3d bbox, 8 pts), project to image coordinate system (2d, 8pts)
...
# given car corners in image coordinate system (2d, 8 pts), draw the 3d box in image
...
# image coordinate system (2d, 1pt), project to 3d car corner (3d, 1pt)
...
# estimate the car's 3d center location & orientation
def ddd2locrot(center, alpha, dim, depth, calib):
  location = unproject_2d_to_3d(center, depth, calib) # given 2d point and its depth, estimate the 3d coordinates.
  location[1] += dim[0] / 2  # add the camera height: half of the car height
  rotation_y = alpha2rot_y(alpha, center[0], calib[0, 2], calib[0, 0]) # calculate the orientation of the car
  return location, rotation_y


# given car center 2d coordinates, find the 2d coordinates of its 8 corners
def project_3d_bbox(location, dim, rotation_y, calib):
  # based on the car center location and car size, find the corners (3d bbox)
  box_3d = compute_box_3d(dim, location, rotation_y)
  # car corners (3d bbox, 8 pts), project back to image coordinate system (2d, 8pts)
